...
def extract_infos_from_img( img_raw, filename, user_id, lang = "fr" ):
    ...
    analyse_face_cuda.getInsightApp() # force le chargement sinon quand on voudra le charger y aura plus de place en m�moire (alors que ollama peut charger en mix si quand il arrive il y a moins)
