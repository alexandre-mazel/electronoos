...
import serial.tools.list_ports # si il ne trouve pas tools, alors il faut  enlever serial qui a etait installe par erreur # sudo pip3 uninstall serial --break-system-packages  
import numpy as np
