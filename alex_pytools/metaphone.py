...
True
>>> dm(u'Bartok'), dm(u'Bartosz'), dm(u'Bartosch'), dm(u'Bartos')
...
def autoTest():
    ...
    assert_check( dm( " apples" ), ('APLS', '') )
    assert_check( dm( "checkin please!" ), ('XKNPLS', '') )
    assert_check( dm( "checking please!" ), ('XKNKPLS', '') )
    assert_check( dm( "chicken please!" ), ('XKNPLS', '') )
    
    
    assert_check( trimNonMeta( " les flageolet?" ), "les flageolet" )
    assert_check( trimNonMeta( " apples" ), "apples" )
    
    assert_check( dm( "tu aimes les pommes?" ), ('TMSLSPMS', '') )
    assert_check( dm( "les flageolet?" ), ('LSFLJLT', 'LSFLKLT') )
    assert_check( dm( "les flageolets?" ), ('LSFLJLTS', 'LSFLKLTS') )
