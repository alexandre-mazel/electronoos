...
void loop() {
    ...
    Serial.println("[*] Scanning WiFi network");
        ...
        int n = WiFi.scanNetworks(false,true,true); // (bool async = false, bool show_hidden = false, bool passive = false, uint32_t max_ms_per_chan = 300, uint8_t channel = 0, const char * ssid=nullptr, const uint8_t * bssid=nullptr);
